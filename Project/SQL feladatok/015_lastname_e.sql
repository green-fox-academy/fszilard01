...
-- ahol a LastName mezõ értéke 'e'-karakterrel végzõdik! 

SELECT * 
FROM Person.Person 
WHERE Person.Person.PersonType = 'EM' AND Person.Person.FirstName = 'John' AND Person.Person.LastName LIKE '%e'
